...
def handler():
    try:
        ...
        if None in [app_name, method, req_id, params, result, sign_params]:
        ...
        response_data['result'] = MuonUtils.call_method(f'muon-apps/{app_name}.py','on_request', data)
        
        response_data['signParams'] = MuonUtils.call_method(f'muon-apps/{app_name}.py', 'sign_params'
